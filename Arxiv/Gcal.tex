...
\hline
1f&0&0&0&0&0&0 \\
2f&0&$9 \frac{Gmr^2}{d^4\omega^2}$&0&$\frac{25}{4} \frac{Gmr^4}{d^6\omega^2}$&0&$\frac{735}{128} \frac{Gmr^6}{d^8\omega^2}$  \\
3f&0&0&0&0&0&0\\
4f&0&0&0&$\frac{175}{16} \frac{Gmr^4}{d^6\omega^2}$&0& $\frac{441}{64} \frac{Gmr^6}{d^8\omega^2}$ \\
5f&0&0&0&0&0&0 \\
...
The gravity field calibrator modulate the mirrors with gradient of gravity potential. However, its gravity gradient act the mass of multi pendulum. We estimated the responses of the each masses using transfer function of KAGRA as shown in Fig.~\ref{fig:ratio}. We can neglect the intermediate mass effect and regard as free mass motion larger than 30 Hz. We assumed the rotation frequency as 16 Hz, which is corresponding to 32 Hz and 48Hz at the operation frequency. of 2-f and 3-f components.  
\begin{figure}
\begin{center}
...
\end{eqnarray}
As you can see, the contribution of the radius uncertainty is amplified by theO(100) factor. To reduce the noise of displacement, we need to reduce the uncertainty of the shape of the rotor and masses.
